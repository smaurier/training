...
const styles = StyleSheet.create({
  ...
  statCell: { flex: 1, padding: Spacing.lg, gap: Spacing.xs },
  statCellBorder: { borderLeftWidth: 1 },
  prCard: { flexDirection: 'row', alignItems: 'flex-start', gap: Spacing.md, borderWidth: 1, borderRadius: Radius.sm, padding: Spacing.lg },
  ...
  progressionSection: { borderWidth: 1, borderRadius: Radius.sm, padding: Spacing.lg, gap: Spacing.md },
  sectionTitle: { fontSize: 15, fontFamily: FontFamily.semibold },
  progressionRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: Spacing.sm, borderBottomWidth: 1 },
  progressionName: { flex: 1, fontSize: 14 },
  progressionValues: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm },
  progressionOld: { fontSize: 13 },
  progressionNew: { fontSize: 13, fontFamily: FontFamily.bold },
  progressionPending: { fontSize: 12 },
  plateauSection: { borderWidth: 1, borderRadius: Radius.sm, padding: Spacing.lg, gap: Spacing.md },
  plateauRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: Spacing.sm, borderBottomWidth: 1 },
  plateauName: { flex: 1, fontSize: 14 },
  plateauWeight: { fontSize: 13 },
  plateauHint: { fontSize: 13, fontStyle: 'italic', marginTop: 2 },
  deloadHintSection: { borderWidth: 1, borderRadius: Radius.sm, padding: Spacing.lg, gap: Spacing.sm },
  ...
  notesInput: { borderWidth: 1, borderRadius: Radius.sm, padding: Spacing.md, fontSize: 14, minHeight: 72, textAlignVertical: 'top' },
  closeBtn: { paddingVertical: Spacing.lg, borderRadius: Radius.sm, alignItems: 'center', marginTop: Spacing.sm },
  closeBtnText: { fontSize: 15, fontFamily: FontFamily.bold, letterSpacing: LetterSpacing.max, textTransform: 'uppercase' },
  cardioCard: { borderWidth: 1, borderRadius: Radius.sm, padding: Spacing.lg, gap: Spacing.md },
  cardioRow: { flexDirection: 'row', gap: Spacing.sm },
  cardioField: { flex: 1, gap: Spacing.xs },
  cardioFieldLabel: { fontSize: 11, fontFamily: FontFamily.semibold, textAlign: 'center' },
  cardioInput: { borderWidth: 1, borderRadius: Radius.sm, padding: Spacing.md, fontSize: 16, textAlign: 'center' },
  cardioRpeRow: { flexDirection: 'row', gap: Spacing.sm },
  cardioRpeChip: { flex: 1, borderWidth: 1, borderRadius: Radius.sm, paddingVertical: Spacing.md, alignItems: 'center' },
  cardioRpeLabel: { fontSize: 13, fontFamily: FontFamily.regular },
  cardioBtnRow: { flexDirection: 'row', gap: Spacing.sm },
  cardioSaveBtn: { flex: 2, paddingVertical: Spacing.lg, borderRadius: Radius.sm, alignItems: 'center' },
  cardioSaveBtnText: { fontSize: 15, fontFamily: FontFamily.bold, letterSpacing: LetterSpacing.max },
  cardioIgnoreBtn: { flex: 1, paddingVertical: Spacing.lg, borderRadius: Radius.sm, alignItems: 'center', borderWidth: 1 },
