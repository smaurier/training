...
const styles = StyleSheet.create({
  ...
  statValue: { fontSize: 22, fontFamily: 'Inter_900Black', letterSpacing: -0.3 },
  ...
  tagLabel: { fontSize: 13, fontFamily: 'Inter_400Regular' },
  ...
  cardioFieldLabel: { fontSize: 11, fontFamily: 'Inter_600SemiBold', textAlign: 'center' },
