...
const styles = StyleSheet.create({
  ...
  card: { borderRadius: Radius.md, padding: Spacing.xxl, alignItems: 'center', width: '100%', maxWidth: 340 },
  title: { fontSize: 18, fontFamily: FontFamily.bold, textAlign: 'center', marginBottom: Spacing.sm },
  ...
  closeBtnText: { fontFamily: FontFamily.bold, fontSize: 16 },
});
