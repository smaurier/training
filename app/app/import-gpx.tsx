  ...
  return (
    ...
    >
      ...
      {!gpxData ? (
        ...
        >
          <Text style={[styles.pickBtnText, { color: colors.onPrimary }]}>Choisir un fichier .gpx</Text>
        </PressableA11y>
      ) : (
        <View style={styles.preview}>
          ...
          <View style={[styles.previewCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            ...
            <View style={styles.rpeRow}>
              {([
                ...
                >
                  <Text style={[styles.rpeLabel, { color: selectedRpe === rpe ? colors.onPrimary : colors.text }]}>{label}</Text>
                </PressableA11y>
              ))}
            </View>
          </View>
          ...
          >
            <Text style={[styles.importBtnText, { color: colors.onPrimary }]}>{loading ? 'Import…' : 'Importer'}</Text>
          </PressableA11y>
